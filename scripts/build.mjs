/**
 * dsh-memory — browser-half bundle build.
 *
 * Produces lib/client.js in the DSH Web client-module wire format:
 * `window.__ModuleLoader__.load({ id, factory: (require) => { ... } })`.
 * The panel CSS is loaded as TEXT (esbuild text loader) and injected as a
 * <style data-plugin> tag at factory execution; platform modules stay
 * external and resolve from the loader module table.
 */
